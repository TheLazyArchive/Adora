...
**Zusammenfassung**
eine ganze Gattung von Käfern, die unter der Rinde von abgestorbenen Bäumen nistet und so lange friedlich ihr Dasein fristet, bis man ihre Behausung beschädigt oder ein "Warn-Phäromon" von einem Artgenossen versprüht wird, wenn er verletzt wird. In diesem Falle sollte man jeden nächsten Schritt mit bedacht wählen, denn aus dem Wald-Boden um einen herum wird dann schnell ein Minenfeld. Diese Käfer werden dann nämlich ihre unauffälligen, flachen Hinterleibe flach auf den Boden legen und in ihrem Inneren einen volatilen Cocktail aus Stickstoff und Sauerstoff mischen. Wenn man dann einen dieser Käfer berührt, wird man wie eine original teller-mine in die Luft gejagt. Die explosionen können bei ausgewachsenen Käfern so stark sein, dass Knochen brechen und einzelne Finger oder auch mal ein Fuß vom Körper getrennt wird. 
